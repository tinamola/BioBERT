...
if [[ ! -f bert/uncased_L-12_H-768_A-12/config.json ]]; then
  mkdir -p 'bert'
  cd bert
...
if [[ ! -f bert/uncased_L-24_H-1024_A-16/config.json ]]; then
  mkdir -p 'bert'
  cd bert
...
if [[ ! -f bert/cased_L-12_H-768_A-12/config.json ]]; then
  mkdir -p 'bert'
  cd bert
...
if [[ ! -f bert/cased_L-24_H-1024_A-16/config.json ]]; then
  mkdir -p 'bert'
  cd bert
