...
class Base_Connector():
    ...
    def init_indices_for_filter_logprobs(self, vocab_subset, logger=None):
        ...
        #indices和index_list里的[4,100,2,5,7,9,8...]对应的position就是vocab_subset里的[word1,word2,word3...word28242]
        return indices, index_list

    def filter_logprobs(self, log_probs, indices): #20000个log prob的location is mapped to vocab_subset 的 location!!!!!!!
